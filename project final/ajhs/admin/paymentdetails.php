...
$i =1;
$stmt = $admin->ret("SELECT * FROM `admin`  WHERE admin.a_id = '$sid' ") ;
...
?>
                    ...
                    <tr>
                      ...
                      <td><?php echo $row['a_holdername'] ; ?></td>
                      
                      <td><?php echo $row['a_accountno'] ; ?></td>
                      
                      
                     
                      <td><?php echo $row['a_bank'] ; ?></td>
                      <td><?php echo $row['a_ifsc'] ; ?></td>
                      <td><img src="../admin/controller/<?php echo $row['a_scanner'] ; ?>" width="100px" height="100px" ></td>
