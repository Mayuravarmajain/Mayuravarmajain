...
<div class="content-wrapper">
    <div class="container-fluid">
        <div class="">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Servoice provider_details</h5>
...
$i =1;
$stmt = $admin->ret("SELECT * FROM `sp` INNER JOIN `category` ON category.c_id = sp.c_id INNER JOIN `location` ON location.l_id = sp.l_id  ORDER BY s_name ASC   ");
