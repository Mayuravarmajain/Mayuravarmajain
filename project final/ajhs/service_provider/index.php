...
$stmtp = $admin->ret("SELECT *  FROM `sp` WHERE `s_id` = '$ssid' ");
  ...
  <!--Start Dashboard Content-->
    ...
    <div class="card-content">
        <div class="row row-group m-0">
            ...
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  <h5 class="text-white mb-0"><?php echo $rowp['sp_totalamt'] ; ?> <span class="float-right"><i class="fa fa-usd"></i></span></h5>
                    <div class="progress my-3" style="height:3px;">
                       <div class="progress-bar" style="width:55%"></div>
                    </div>
            ...
            <div class="col-12 col-lg-6 col-xl-3 border-light">
                <div class="card-body">
                  ...
                  <p class="mb-0 text-white small-font">Messages <span class="float-right"></span></p>
                </div>
            </div>
        </div>
    </div>
...
<div class=" rounded h-100 p-4" style="border:  solid 2px">
 ...
 <div class="clearfix" style="margin-top:100px ; " ></div>
  ...
  $i =1;
  $stmt = $admin->ret("SELECT * FROM  `booking` INNER JOIN `payment` ON payment.bo_id = booking.bo_id  INNER JOIN  `services` ON services.se_id = booking.se_id  INNER JOIN `category` ON category.c_id = services.c_id INNER JOIN `sp` ON sp.s_id = booking.s_id WHERE  booking.s_id = '$sid' AND booking.bo_date BETWEEN '$fdate' AND '$tdate' ") ;
