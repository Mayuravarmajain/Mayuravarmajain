          ...
          <div class="card-body p-4">
            ...
            <h4 class="mb-3" style="color:black">Payment</h4>
              ...
              <div class="d-flex justify-content-between align-items-center pb-2">
                ...
                <div class="form-outline">
                  <input type="text" id="amt" name="amount" value="<?php echo $row['bo_amt']-($row['bo_amt']*0.05) ; ?>" readonly class="form-control form-control-lg" siez="17"
                    placeholder="" />
                          ...
                          <label style="font-family: 'Open Sans', sans-serif;">Cash On Delivery</label>
                            ...
                            <div class="Pement">
                                    <div class="form-box" style="display: flex;flex-direction:column">
                                        ...
                                        <input type="text" name="card" value="<?php echo $rows['s_holdername'] ; ?>" placeholder="name of the card " style="width: 200px;">

                                    </div>
                                    <br>
                                    <div class="form-box" style="display: flex;flex-direction:column">
                                        <label>Branch Name</label>
                                        <input type="text" name="expr" value="<?php echo $rows['s_bank'] ; ?>"  placeholder="Expiration date required" style="width: 200px;">


                                    </div><br>
                                    <div class="form-box" style="display: flex;flex-direction:column">
                                        <label>Creadit Card Number</label>
                                        <input type="password" name="no" value="<?php echo $rows['s_accountno'] ; ?>" placeholder="0000 0000 0000 0000 " style="width: 200px;">
                                    ...
                                    <div class="form-box" style="display: flex;flex-direction:column">
                                        ...
                                        <input type="password" name="cvv" value="<?php echo $rows['s_ifsc'] ; ?>" placeholder="CVV Number" style="width: 200px;">
                ...
                <button type="submit" name="submit" class="btn btn-success btn-lg btn-rounded"> Complete Payment<i class="fas fa-arrow-right"></i>
                </button> 
              </div>
            </form>
          </div>
